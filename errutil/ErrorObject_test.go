...
func Test_ErrorObject_chain_basic(t *testing.T) {
	...
	err3 := New("err3", err2)
	require.Error(err3)
	require.Equal("err3", err3.Error())
	require.Error(err3.Parent())
	require.Equal("err2", err3.Parent().Error())
